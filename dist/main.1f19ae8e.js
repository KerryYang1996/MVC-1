...
},{"_css_loader":"C:/Users/Administrator/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/css-loader.js"}],"body.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var $number = (0, _jquery.default)("#number"); //先从本地仓库获取n的值，放到id=number的div里
//如果本地仓库没有n，则默认为100

var n = localStorage.getItem("n");
$number.text(n || 100);
$button1.on("click", function () {
  var n = parseInt($number.text()); //获取number.text并把它变成整数
...
var $tabContent = (0, _jquery.default)("#app2 #tab-content"); //事件委托，监听父元素，通过触发子元素监听达到触发父元素的目的
//触发tab-bar的子元素li触发响应
...
$tabBar.on("click", "li", function (e) {
  ...
  var index = $li.index(); //获取下标

  console.log(index);
  $tabContent.children().eq(index).addClass("active") //tabContent的孩子中等于index的加样式display：block
  .siblings().removeClass("active"); //index个孩子的兄弟姐妹们加样式display：none
});
...
require("./app4.js");
},{"./reset.css":"reset.css","./body.css":"body.css","./app1.js":"app1.js","./app2.js":"app2.js","./app3.js":"app3.js","./app4.js":"app4.js"}],"C:/Users/Administrator/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
